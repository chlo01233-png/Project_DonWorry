...
public class ResumeDTO {
    ...
    private String prferred_job;     // 희망업종 
	...
	public ResumeDTO(int seq, String id, String title, String prferred_job, String working_condition, String career,
			String career_write, String introduction, Timestamp resume_date) {
		super();
		this.seq = seq;
		this.id = id;
		this.title = title;
		this.prferred_job = prferred_job;
	...
	public String getPrferred_job() {
		return prferred_job;
	}

	public void setPrferred_job(String prferred_job) {
		this.prferred_job = prferred_job;
	}
