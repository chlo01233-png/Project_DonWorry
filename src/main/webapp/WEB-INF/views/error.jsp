...
<div class="container">
        ...
        <c:choose>
            ...
            <c:otherwise>
                <span style="font-size: 13px; color: #666;">
                    ...
                    ${nickName}님 환영합니다.
                    <a href="/members/logout"><button class="logout-btn" style="margin-left:10px;">로그아웃</button></a>
                </span>
            </c:otherwise>
        </c:choose>
    </div>
    ...
    <nav class="navbar">
        <div style="display: flex; align-items: center; gap: 40px;">
            ...
            <div class="nav-menu">
                <a href="/">홈</a>
                <a href="/salary/calendar">급여 캘린더</a>
                <a href="/jobposts/jobpost">구인구직</a>
                <a href="/boards/mainboard_list?page=1">커뮤니티</a>
                <a href="/qna/qna?page=1">고객지원</a>
            </div>
        </div>
