    ...
    <div class="edit-section">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-input" readonly 
             name="id" value="${list.id}" style="background-color: #f9fafb; color: #999; cursor: not-allowed;">
        </div>

        <div class="form-group">
            <label class="form-label">닉네임</label>
            <input type="text" class="form-input update-input" placeholder="닉네임을 입력하세요" readonly 
            name="nickname" value="${list.nickname}" style="background-color: #f9fafb; color: #999; cursor: not-allowed;" >
        </div>

		<div class="form-group">
            <label class="form-label">이름</label>
            <input type="text" class="form-input" value="사용자" readonly 
			name="name" value="${list.name}" style="background-color: #f9fafb; color: #999; cursor: not-allowed;">
        </div>

		<div class="form-group">
            <label class="form-label">생년월일</label>
            <input type="text" class="form-input" value="2011-11-11" readonly 
			name="rrn" value="${list.rrn}" style="background-color: #f9fafb; color: #999; cursor: not-allowed;">
        </div>

		<div class="form-group">
            <label class="form-label">전화번호</label>
            <input type="text" class="form-input update-input" placeholder="전화번호를 입력하세요" readonly 
            name="phone" value="${list.phone}" style="background-color: #f9fafb; color: #999; cursor: not-allowed;" >
        </div>

        <div class="form-group">
            <label class="form-label">이메일 주소</label>
            <input type="email" class="form-input update-input" placeholder="이메일을 입력하세요" readonly 
			name="email" value="${list.email}" style="background-color: #f9fafb; color: #999; cursor: not-allowed;" >
        </div>
    </div>
